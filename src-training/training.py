...
for gg in range(3,19):
    for i in range(88):
        ...
        data_x,data_y = create_problem.create(nb_training,i,gg)
        ...
        history = model.fit(x_train, y_train, batch_size=100, epochs=10,verbose=1,validation_data=(x_valid, y_valid),callbacks=[early_stopping,lr_decay])
